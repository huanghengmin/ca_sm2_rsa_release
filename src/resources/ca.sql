...
# Dumping database structure for ca
DROP DATABASE IF EXISTS `ca`;
CREATE DATABASE IF NOT EXISTS `ca` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ca`;


# Dumping structure for table ca.account
...
# Dumping data for table ca.account: ~5 rows (approximately)
...
# Dumping structure for table ca.account_role
...
# Dumping data for table ca.account_role: ~5 rows (approximately)
...
# Dumping structure for table ca.business_log
...
# Dumping data for table ca.business_log: ~0 rows (approximately)
/*!40000 ALTER TABLE `business_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `business_log` ENABLE KEYS */;


# Dumping structure for table ca.district
...
# Dumping data for table ca.district: ~4,066 rows (approximately)
...
# Dumping structure for table ca.permission
...
# Dumping data for table ca.permission: ~28 rows (approximately)
...
REPLACE INTO `permission` (`ID`, `CODE`, `NAME`, `DESCRIPTION`, `PARENT_ID`, `SEQ`) VALUES
	...
	(140, 'TOP_CAGN', 'CA功能', NULL, 0, 0),
	(141, 'SECOND_CAPZ', 'CA配置', NULL, 140, 1),
	(142, 'SECOND_CAXX', 'CA信息', NULL, 140, 2),
	(150, 'TOP_RAGN', 'RA功能', NULL, 0, 0),
	(151, 'SECOND_YHZZ', '用户证书', NULL, 150, 1),
	(152, 'SECOND_SBZZ', '设备证书', NULL, 150, 2),
	(160, 'TOP_XTPZ', '系统配置', NULL, 0, 0),
	(161, 'SECOND_LDAP', 'LDAP配置', NULL, 160, 1),
	(162, 'SECOND_RZZJ', '日志主机', NULL, 160, 2),
	(170, 'TOP_JKGL', '监控管理', NULL, 0, 0),
	(171, 'SECOND_ZJJK', '主机监控', NULL, 170, 1);
/*!40000 ALTER TABLE `permission` ENABLE KEYS */;


# Dumping structure for table ca.role
...
# Dumping data for table ca.role: ~5 rows (approximately)
/*!40000 ALTER TABLE `role` DISABLE KEYS */;
REPLACE INTO `role` (`id`, `name`, `description`, `createdTime`, `modifiedTime`) VALUES
	(1, '初始化管理员', '初始化管理员', '2010-07-04 15:07:08', '2014-12-22 13:31:19'),
	...
	(5, '测试', '测试', '2014-04-01 13:29:08', NULL);
/*!40000 ALTER TABLE `role` ENABLE KEYS */;


# Dumping structure for table ca.role_permission
...
# Dumping data for table ca.role_permission: ~30 rows (approximately)
...
# Dumping structure for table ca.safe_policy
...
# Dumping data for table ca.safe_policy: ~0 rows (approximately)
...
# Dumping structure for table ca.sys_log
...
# Dumping data for table ca.sys_log: ~0 rows (approximately)
/*!40000 ALTER TABLE `sys_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_log` ENABLE KEYS */;


# Dumping structure for table ca.user_oper_log
...
# Dumping data for table ca.user_oper_log: ~0 rows (approximately)
