...
public class FileUtil {
     ...
     * @param to    保存后文件地址
     */
    public static void copy(byte[] bytes, String to) throws IOException {
...
//            out.close();
    ...
    public static HttpServletResponse copy(byte[] encoded, HttpServletResponse response) {
        ServletOutputStream out = null;
        try {
            out = response.getOutputStream();
            out.write(encoded);
...
//            out.close();
    ...
    public static void copyBytes(byte[] encoded, String s) {
        FileOutputStream bos = null;
        try {
            bos = new FileOutputStream( new File(s));
            bos.write(encoded);
            bos.flush();
            bos.close();
        } catch (FileNotFoundException e) {
